from app.bot.utils import get_vacancies
from app.bot.templates.vacancy import vacancy_card
from app.bot.templates.start import setup_profile_start, setup_profile_1, setup_profile_2, setup_profile_3, setup_profile_ready
