...
from app.handlers.main_menu import (
    ...
    start_setup_callback, render_main_menu_callback
)

from app.handlers.vacancies import render_vacancies, render_vacancies_callback
...
def register_handlers(dp: Dispatcher):
    ...
    dp.callback_query.register(start_setup_callback, F.data == "profile_setup:start")
